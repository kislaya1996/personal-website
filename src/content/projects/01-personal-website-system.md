...
subtitle: A minimal, content-driven portfolio that can grow through Markdown files and deploy as static assets.
...
- Homepage previews show only a few items per section.
- Section pages collect the full list.
- Write-up pages provide a focused reading layout.
- Markdown supports rich text and images.
